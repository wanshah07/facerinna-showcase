/* The counter screen.
   ...
   The camera itself is not under test here; the frames a lens would produce
   are not something this harness can honestly fake. What IS tested is every
   step after a code is read, driven through the page's own reader. */
